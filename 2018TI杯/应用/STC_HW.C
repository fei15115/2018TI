...
//   P3M1      =  0x00;  //P3[0..7]--RXD,TXD,INT01,T0,CM1,INT23--准双向
  ...
  P3M0      =  0X02;
  P4M1      =  0x02;
  P4M0      =  0x0D;  //P4[0..4]---CSDA,LCDCS,WR,FCS,2401CS推挽
  P5M1      =  0X00;
  P5M0      =  0x02;
  P7M1      =  0x00;
  P7M0      =  0X08;
...
//3.1-----T0和T1
   ...
   TH0	   = (65536 - 33000000/400) /256 ;
   TL0	   = (65536 - 33000000/400) %256 ; //定时器0初值(1秒400次中断2.5ms)
   //TR0     = 1 ;  	//定时器0开始运行
   //TR1     = 1 ;    //定时器1开始运行
   ET0     = 1 ;		//定时器0中断许可	*/
//4-----AD配置
...
//5----串口配置
   ...
   T2H       = (65536 - (33000000/38400/4))/256;//设置波特率38400
   T2L       = (65536 - (33000000/38400/4))%256;
